...
import winsound
import random
events_list = ["Входим в особую зону, где происходит рождение звезд", "Приближаемся к Галактике Андромеды", "Внимание! Летит астероид. Предпримите меры!", "Обнаружены космические пираты!"]
...
while True:
    ...
    elif select == 4 and event == "Обнаружены космические пираты!":
